...
public class ManagerDenyRequestsServlet extends HttpServlet {
...
PrintWriter out=response.getWriter();
        ...
        List<EmpReimbursementEntity> denied =reimbRequest.viewDeniedRequests();
        
        System.out.println(denied);
        for(EmpReimbursementEntity e:denied)
	   	{
